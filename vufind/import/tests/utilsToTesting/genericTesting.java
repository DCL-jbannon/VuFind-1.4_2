...
public class genericTesting
{
	...
	public void test1() throws SQLException
	{
		...
		String databaseConnectionInfo = "jdbc:mysql://10.254.2.93/dclecontent_test?user=dclvufind&password=DcLvf!nd&useUnicode=yes&characterEncoding=UTF-8";
		Connection conn = DriverManager.getConnection(databaseConnectionInfo);		
		IOverDriveAPIServices overDriveAPI = new OverDriveAPIServices("DouglasCL", "aha4lf0c2opJGfaRHxtkIEajvb3x2YKV", 1344);
