...
class EContentItem extends DB_DataObject implements IEContentItem{
	...
	function insert(){
		...
		if ($this->getAccessType() == 'acs' && ($this->item_type == 'epub' || $this->item_type == 'pdf')){
			$uploadResults = AdobeContentServer::packageFile($configArray['EContent']['library'] . '/' . $this->filename, $this->recordId,"","",$this->getAvailableCopies());
