    ...
    <div class="searchheader">
      <div class="searchcontent">
        ...
        {if $pageTemplate != 'advanced.tpl'}
          ...
          {/if}
        {/if}
		<div class='message-alert' style='display:block;'>Please note that catalog search results might return an error screen. <a target="_blank" href="http://hip.douglascountylibraries.org/ipac20/ipac.jsp?forcelogout=true&amp;profile=rem&amp;lang=eng">Click here to go to the classic catalog</a>.</div>
