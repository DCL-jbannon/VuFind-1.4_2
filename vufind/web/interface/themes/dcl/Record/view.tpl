...
<div id="page-content" class="content">
  ...
  <div id="main-content" class="full-result-content">
    <div id="record-header">
      ...
      {if is_array($recordFormat)}        
       {foreach from=$recordFormat item=displayFormat name=loop}
		{if (($displayFormat != 'Photographs') && ($displayFormat != 'Comic Book')) }
    ...
    <div id="moredetails-tabs">
      ...
      <div id = "holdingstab">
		...
		{else}
		 <div class='purchaseTitle button'><a href="{$internetLink.link|escape}">{translate text=$internetLink.linkText|escape}</a></div><br/>		 
		{/if}
		{/foreach}
		{/if}
