...
<div id="page-content" class="content">
  ...
  <div id="main-content" class="full-result-content">
    <div id="record-header">
      ...
      {* Checkout *}
	  <div id="checkout{$id|escape:"url"}" class="generic-item-background checkoutLink"  style="display:none;">
			<a alt="Checkout" title="Checkout" href="{$path}/EcontentRecord/{$id|escape:"url"}/Checkout" class="generic-item-text">
				Checkout
		 	</a>
	  </div>
	  
	  {* Place Hold *}
	  <div id="placeHold{$id|escape:"url"}" class="generic-item-background requestThisLink" style="display:none;">
			<a alt="Place Hold" title="Place Hold" href="{$path}/EcontentRecord/{$id|escape:"url"}/Hold" class="generic-item-text">
				Place Hold
		 	</a>
	  </div>
	  ...
	  *}
	  ...
	  {* Add to Wish List *}
	  <div  id="addToWishList{$id|escape:"url"}" class="generic-item-background-wishList addToWishListLink" style="display:none;">
			<a alt="Add to Wish List" title="Add to Wish List" href="{$path}/EcontentRecord/{$id|escape:"url"}/AddToWishList" class="generic-item-text">
				Add to<br/>Wish List
		 	</a>
	  </div>
	  
	  <div id='samplesTitles' style="display:none">
    ...
    <div id="moredetails-tabs">
      ...
      {else}
			<div id = "stafftab">
				{include file='RecordDrivers/Marc/staffnoinfo.tpl'}
			</div>
	  {/if}
    </div> {* End of tabs*}
