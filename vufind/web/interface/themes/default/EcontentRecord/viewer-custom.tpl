        ...
        $(document).ready(function(){
          /*$('#reader').click(function (e){
	        ...
	        $('#reader a').live('click', function (e){
		        ...
		        if (componentParts == href)
		        {
		        	//External link or mailto link
		        	window.open(href, '_blank');
		        	return false;
		        }
		        
		        console.log(componentParts);
		        component = componentParts[1];
	          //Strip of the current page url if it exists. 
	          anchor = componentParts[2];
  ...
  <body oncontextmenu="return false;">
  	<div id='hideableHeader'>
	  	...
	  	<div id="ereaderlogo" class="searchheader">
	  		<a href="{if $homeLink}{$homeLink}{else}{$url}{/if}"><img src="{$path}/interface/themes/dcl/images/logo_ereader.png" alt="{$libraryName}" /></a>
