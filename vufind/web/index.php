 ...
 * iDCLReader init
 */
$isIosPortalDevComp = $iDCLReaderService->isIOSPortalDeviceCompatible();
$interface->assign("isIOSPortalDeviceCompatible",$isIosPortalDevComp);
$interface->assign("isIDCLReader",$configArray['iDCLReader']['isIDCLReader']);
/**
 * End iDCLReader init
 */
 ...
 */
$interface->assign("GACode",$configArray['Site']['GACode']);
