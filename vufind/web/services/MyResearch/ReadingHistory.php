	...
	function launch()
	{
		...
		if ($this->catalog->status)
		{
			if ($user->cat_username)
			{
				...
				foreach($result['titles'] as $key=>$val)
				{
					$result['titles'][$key]['bookCoverUrl'] = '';
					if ($result['titles'][$key]['format_category'] == 'emedia')
					{
						$isbn = $result['titles'][$key]['isbn'];
						$econtentRecordId = $result['titles'][$key]['recordId'];
						$result['titles'][$key]['bookCoverUrl'] = $bookCoverUrl->getBookCoverUrl("small", $isbn, $econtentRecordId, true);
					}
				}
