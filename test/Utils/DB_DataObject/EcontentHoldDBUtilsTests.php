...
require_once dirname(__FILE__).'/../../../vufind/classes/Utils/DB_DataObject/EcontentHoldDBUtils.php';

class EcontentHoldDBUtilsTests extends DB_DataObjectUtilsTests
{
