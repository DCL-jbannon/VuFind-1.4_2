...
require_once dirname(__FILE__).'/../../../vufind/classes/Utils/DB_DataObject/CommentsDBUtils.php';

class CommentsDBUtilsTests extends DB_DataObjectUtilsTests
{
